        ...
        this.sendTimedMessage(
                ...
                this.getEmbedBuilder(commandParameters)
                        ...
                        .addField("Data Collection", "The bot is only saving the minimal data to work, like the number of used commands, but not the actual command. "
                                ...
                                + MarkdownUtil.monospace(DiscordBot.getCommandManager().getMainCommand() + " deleteMyAccount") + " command. Abuse of this command could result in a ban, be warned.", false)
