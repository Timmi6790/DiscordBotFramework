...
public class DiscordEventListener extends ListenerAdapter {
    ...
    public void onMessageReceived(@Nonnull final net.dv8tion.jda.api.events.message.MessageReceivedEvent event) {
        ...
        DiscordBot.getModuleManager().getModuleOrThrow(EventModule.class).executeEvent(messageReceivedIntEvent);
    }

    @Override
    public void onMessageReactionAdd(@Nonnull final MessageReactionAddEvent event) {
        DiscordBot.getModuleManager().getModuleOrThrow(EventModule.class).executeEvent(event);
    }
