...
public class CooldownProperty implements CommandProperty<Boolean> {
    ...
    protected void sendErrorMessage(final CommandParameters commandParameters, final long cooldownTill) {
