...
ALTER TABLE `rank_relation` ADD CONSTRAINT `rank_relation-parent_rank_id` FOREIGN KEY (`parent_rank_id`) REFERENCES `rank` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE `rank_relation` ADD CONSTRAINT `rank_relation-child_rank_id` FOREIGN KEY (`child_rank_id`) REFERENCES `rank` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
